  ...
  return (
    <div className='z-20 h-full  w-full'>
      <div className='w-full absolute top-5 px-14 flex justify-between max-[600px]:justify-center  min-[1600px]:px-[290px] xl:px-[160px]  max-[600px]:flex-col  items-center'>
        <h1 className='text-[35px] z-20 text-white font-semibold  text-center min-[1330px]:text-[45px] xl:text-[35px] xl:font-semibold  max-[600px]:text-[30px] max-[410px]:text-[20px]  max-[600px]:font-semibold '>Ahtesham {''}<span className='text-[25px] text-[#d3352f]'> Javeed</span> </h1>
        <div className='flex justify-center items-center gap-4'>
          <Link href="/work" className='[&>svg]:hover:fill-[#d3352f] z-20 [&>svg]:fill-white cursor-pointer'>
          ...
          <Link href="/work" className=' z-20 cursor-pointer'>
            <svg xmlns="http://www.w3.org/2000/svg" className="w-[18px] h-[18px] [&>g]:hover:stroke-[#d3352f] [&>g]:stroke-white" viewBox="0 0 24 24">
