  ...
  return (
    <nav className='flex flex-col items-center xl:justify-center gap-y-4 fixed h-max bottom-0 mt-auto xl:right-[2%] z-20 top-0 w-full xl:w-16 xl:max-w-md xl:h-screen '>
      <div className='flex w-full xl:flex-col items-center justify-between xl:px-0 md:px-40 xl:justify-center gap-y-8 px-4 h-[80px] py-8 xl:h-max bg-white/10 backdrop-blur-sm text-3xl xl:text-xl xl:rounded-full'>
        ...
        <Link className=" [&>svg]:hover:fill-[#d3352f] relative flex items-center cursor-pointer group [&>svg]:fill-white transitions-all duration-300" href='/'>
        ...
        <Link className=" [&>svg]:hover:fill-[#d3352f] relative flex items-center cursor-pointer group [&>svg]:fill-white transitions-all duration-300" href='/about'>
        ...
        <Link className=" [&>svg]:hover:fill-[#d3352f] relative flex items-center cursor-pointer group [&>svg]:fill-white transitions-all duration-300" href='/service' >
          <div className='absolute pr-14 right-0 hidden xl:group-hover:flex '>
            <div className='bg-white relative flex text-[#261a4b] items-center p-[6px] rounded-[3px] '>
              <div className='text-[12px] leading-none font-semibold capitalize '>
                Service
        ...
        <Link className=" [&>svg]:hover:fill-[#d3352f] relative flex items-center cursor-pointer group [&>svg]:fill-white transitions-all duration-300" href='/work' >
          <div className='absolute pr-14 right-0 hidden xl:group-hover:flex '>
            <div className='bg-white relative flex text-[#261a4b] items-center p-[6px] rounded-[3px] '>
              <div className='text-[12px] leading-none font-semibold capitalize '>
                Work
        ...
        <Link className=" [&>svg]:hover:fill-[#d3352f] relative flex items-center cursor-pointer group [&>svg]:fill-white transitions-all duration-300" href='/testimonials' >
          <div className='absolute pr-14 right-0 hidden xl:group-hover:flex '>
            <div className='bg-white relative flex text-[#261a4b] items-center p-[6px] rounded-[3px] '>
              <div className='text-[12px] leading-none font-semibold capitalize '>
                Testimonials
        ...
        <Link className=" [&>svg]:hover:fill-[#d3352f] relative flex items-center cursor-pointer group [&>svg]:fill-white transitions-all duration-300" href='/contact' >
          <div className='absolute pr-14 right-0 hidden xl:group-hover:flex '>
            <div className='bg-white relative flex text-[#261a4b] items-center p-[6px] rounded-[3px] '>
              <div className='text-[12px] leading-none font-semibold capitalize '>
                Contact
