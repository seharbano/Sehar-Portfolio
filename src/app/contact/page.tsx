      ...
      <div className="h-screen min-[1600px]:px-[260px] xl:px-[160px] max-[1280px]:px-5 flex justify-center w-full items-center bg-gradient-to-r from-primary/10 via-black/30 to-black/10">
        <div className='w-full flex flex-col justify-center items-center '>
          <motion.h1
            ...
            className="text-[35px] min-[1330px]:text-[45px] xl:text-[35px] xl:font-semibold z-20 max-[600px]:text-[30px] max-[410px]:text-[20px] max-[620px]:px-4 max-[600px]:font-semibold font-bold">Let &rsquo;s {""}<span className="text-[#d3352f]"> Contact.</span>
          </motion.h1>
          <div className='w-full px-[250px] max-[900px]:px-[50px] max-[450px]:px-6'>
            ...
            >
              ...
              <div className=''>
                <Button className='border border-gray-500 w-[120px] hover:bg-transparent hover:text-red-500 h-[40px] bg-transparent mt-4 rounded-[20px]'>let&rsquo;s talk </Button>
              </div>
            </motion.div>
            <div>
