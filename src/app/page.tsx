...
const Home = () => {
  return (
    <div className="h-[100vh] custom-gradient">
      <div className="w-full  ">
        <div className="text-center flex flex-col justify-center h-[100vh] items-center xl:items-start min-[1600px]:px-[290px] xl:px-[160px] max-[1280px]:px-5  min-[1380px]:pb-20 min-[1279px]:pb-0 xl:text-left ">
          <motion.h1
            ...
            className="text-[40px] z-20 max-[600px]:text-[30px] max-[600px]:font-semibold font-bold">Transforming Ideas <br /> Into {''} <span className="text-[#fcd34d]">Digital Reality</span></motion.h1>
          <motion.p
            variants={fadeIn('down', 0.3)} initial="hidden" animate="show" exit="hidden"
            className="max-w-sm xl:max-w-xl text-white mx-auto xl:mx-0 mb-8 xl:mb-10 z-20">Lorem ipsum dolor sit amet consectetur adipisicing elit. Asperiores natus odit et tempora
      ...
      <div className="w-[1200px] h-full absolute right-0 bottom-0">
        ...
        <motion.div
          ...
          className="w-full h-full max-w-[707px] max-h-[678px] max-[1380px]:max-h-[550px] max-[1380px]:right-[10px] z-[10] absolute bottom-[1px] lg:bottom-0  right-[-45px] ">
          <Avator />
        </motion.div>
